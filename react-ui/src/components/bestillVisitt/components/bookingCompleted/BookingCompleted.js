    ...
    <div>
        <main className="confirmation-container">
            <div className="row middle-xs page-sub-heading">
                <h2 className="col-xs">Takk for bestillingen din, vi gleder oss til � vise frem boligen</h2>
                <img src={hjem} viewBox="0 0 500 500"/>
            </div>
            <p className="notification">Din Visitt visning er n� bestilt. Du vil motta bekreftelse p� epost.</p>
            ...
            <div className="row center-xs">
                <Link to="/" className="orange-button" target="_blank">G� til forsiden</Link>
            </div>
        </main>
    </div>
)